        ...
        if (content && content.trim()) {
            if (isJSON) {
                ...
                try {
                    ...
                    console.log('ContentUpdatePlugin: Successfully loaded from Lexical JSON');
                    ...
                    console.error('ContentUpdatePlugin: Error parsing Lexical JSON, falling back to plain text:', error);
                    // Fall through to plain text handling
                    loadAsPlainText(editor, content, isMajorChange, scrollContainer, savedScrollTop);
                }
            } else {
...
function loadAsPlainText(
    ...
    editor.update(() => {
        ...
        console.log('ContentUpdatePlugin: Loaded content as plain text with OriginTextNode');
