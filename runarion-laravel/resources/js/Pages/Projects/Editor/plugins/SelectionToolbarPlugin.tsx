                        ...
                        <div className="space-y-2">
                            <div className="flex gap-2">
                                <Textarea
                                    ...
                                    className="min-h-20 max-h-[200px] bg-zinc-800 border-zinc-700 text-white placeholder:text-zinc-500 text-sm focus:ring-violet-500 focus:border-violet-500 resize-y"
                                    autoFocus
                                />
