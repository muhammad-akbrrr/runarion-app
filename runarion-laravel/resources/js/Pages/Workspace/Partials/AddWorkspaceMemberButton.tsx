...
export default function AddWorkspaceMemberButton({
    workspaceId,
    role,
}: {
    workspaceId: number;
    ...
    useEffect(() => {
        ...
        const path = `${host}/workspace-members/${workspaceId}/unassigned`;
    ...
    const handleAdd = () =>
        router.post(
            route("workspace-members.assign"),
            {
            ...
            <Dialog open={open} onOpenChange={handleOpenChange}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Type/search email addresses of the members you want
                            to add to this workspace. You can add multiple
