...
class ParagraphExtractor:
    ...
    def __init__(
        ...
        Args:
            ...
            end_page (int | None): Page number to stop extraction at. None means till the last page.
            min_char_len (int): Minimum character length for a paragraph.
            max_char_len (int): Maximum character length for a paragraph.
            sentence_endings (list[str] | None): Sentence ending characters to identify paragraph endings and split paragraphs. Defaults to ".", "!", "?", and their variations within quotes.
        """
    ...
    def split_paragraph(self, text: str, max_len: int | None = None) -> list[str]:
        ...
        Args:
            ...
            max_len (int | None): Maximum length of each split. Defaults to `self.max_char_len`.
